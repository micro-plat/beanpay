...
// NewBalanceHandler .
func NewBalanceHandler() (u *BalanceHandler) {
	return &BalanceHandler{}
}

//AddHandle 帐户加款
func (u *BalanceHandler) AddHandle(ctx hydra.IContext) (r interface{}) {
	ctx.Log().Info("---------------帐户加款--------------------")
	ctx.Log().Info("1. 参数校验")
...
func (u *BalanceHandler) ReverseAddHandle(ctx hydra.IContext) (r interface{}) {
	ctx.Log().Info("---------------帐户红冲加款--------------------")
	ctx.Log().Info("1. 参数校验")
...
//DrawingHandle 帐户提款
func (u *BalanceHandler) DrawingHandle(ctx hydra.IContext) (r interface{}) {
	ctx.Log().Info("---------------帐户提款--------------------")
	ctx.Log().Info("1. 参数校验")
	if err := ctx.Request().Check("ident", "group", "eid", "trade_no", "amount"); err != nil {
		return err
...
func (u *BalanceHandler) ReverseDrawingHandle(ctx hydra.IContext) (r interface{}) {
	ctx.Log().Info("---------------帐户红冲提款--------------------")
	ctx.Log().Info("1. 参数校验")
	if err := ctx.Request().Check("ident", "group", "eid", "trade_no", "ext_no", "trade_type", "memo"); err != nil {
		return err
...
func (u *BalanceHandler) SetCreditHandle(ctx hydra.IContext) (r interface{}) {
	ctx.Log().Info("---------------设置授信金额--------------------")
	ctx.Log().Info("1. 参数校验")
...
//DeductHandle 帐户扣款
func (u *BalanceHandler) DeductHandle(ctx hydra.IContext) (r interface{}) {
	ctx.Log().Info("---------------帐户扣款--------------------")
	ctx.Log().Info("1. 参数校验")
...
//RefundHandle 帐户退款
func (u *BalanceHandler) RefundHandle(ctx hydra.IContext) (r interface{}) {
	ctx.Log().Info("---------------帐户退款--------------------")
	ctx.Log().Info("1. 参数校验")
...
func (u *BalanceHandler) TradeFlatHandle(ctx hydra.IContext) (r interface{}) {
	ctx.Log().Info("---------------交易平账--------------------")
	ctx.Log().Info("1. 参数校验")
...
func (u *BalanceHandler) BalanceFlatHandle(ctx hydra.IContext) (r interface{}) {
	ctx.Log().Info("---------------余额平账--------------------")
	ctx.Log().Info("1. 参数校验")
	if err := ctx.Request().Check("ident", "group", "eid", "trade_no", "trade_type", "amount"); err != nil {
		return err
