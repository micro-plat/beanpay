 ...
 drop table beanpay_account_info;
	...
	create table beanpay_account_info(
		account_id bigint  not null PRIMARY KEY AUTO_INCREMENT  comment '帐户编号' ,
		account_name varchar(32)  not null    comment '帐户名称' ,
		uaid varchar(32)  not null    comment '外部用户账户编号' ,
	...
	drop index beanpay_account_info_uaid ON beanpay_account_info;
 create unique index beanpay_account_info_uaid ON beanpay_account_info(uaid);
