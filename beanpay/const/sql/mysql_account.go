...
(account_id,trade_no,deduct_no,change_type,amount,balance,create_time,trade_type,ext)
select @account_id,@trade_no,@deduct_no,@change_type,@amount,t.balance,now(),@trade_type,@ext
