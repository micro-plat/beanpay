...
(
	...
	deduct_no varchar(32) default 0 ,
...
comment on table beanpay_account_record is '账户余额变动信息';
	...
	comment on column beanpay_account_record.deduct_no is '扣款编号';	
...
alter table beanpay_account_record
	add constraint beanpay_acct_record_account_id unique(account_id,trade_no,change_type,trade_type);
