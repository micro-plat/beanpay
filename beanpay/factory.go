...
type IAccount interface {
	...
	QueryAccount(i interface{}, ident, group, eid, accountType, name string, pi, ps, status int) (r *account.AccountInfoList, err error)
	...
	QueryAccountRecords(i interface{}, accountType string, accountID string, group string, changeType string, tradeType string, eid string, startTime string, endTime string, pi int, ps int) (*account.RecordResults, error)
